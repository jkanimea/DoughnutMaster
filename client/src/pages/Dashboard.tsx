...
import { CreditCard, Package, User as UserIcon, UserPlus } from "lucide-react";
  ...
  return (
    <Card data-testid="register-card">
      <CardHeader>
        ...
        <CardDescription>Join DonutMaster Pro and start ordering delicious treats!</CardDescription>
      </CardHeader>
      ...
      <CardFooter className="justify-center">
        <p className="text-sm text-muted-foreground">
          ...
          <a href="/login" className="text-amber-600 hover:underline" data-testid="link-login">
            Sign in
          </a>
        </p>
      </CardFooter>
           ...
           <div className="container flex-1 py-10 px-4 md:px-6">
              <div className="max-w-2xl mx-auto">
                 <div className="text-center mb-8">
                    <h1 className="text-3xl font-serif font-bold mb-2">Welcome to DonutMaster Pro</h1>
                    <p className="text-muted-foreground">Create an account or sign in to manage your orders</p>
                 </div>
                 <RegistrationForm />
              </div>
           </div>
